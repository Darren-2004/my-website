            ...
            <div className="h-full">
                <nav className="h-15 bg-white divide-x-4 border-black border-b-2">
                    <div className="flex text-xs gap-10 justify-between p-5">
                        ...
                        <a className="hidden lg:block" href="">CONTACT US</a>
                    </div>
                </nav>
                 <div className={`fixed inset-0 bg-gray-800 bg-black  blur-sm transition-opacity ${isMenuOpen ? "opacity-25 " : "opacity-0 pointer-events-none"}`} onClick={toggleMenu}></div>
                <div className={`fixed left-0 top-0 h-full  bg-opacity-30  w-64 bg-white shadow-lg transform transition-transform ${isMenuOpen ? "translate-x-0" : "-translate-x-full"}`}>
                    <div className="p-4 divide-y-1 relative">
                        <button onClick={toggleMenu} className="mt-4 border-none absolute text-2xl top-0 right-5">X</button>
                        <h2 className="text-xl font-bold mb-4 border-none">Menu</h2>
                        <a href="" className="block mb-2 py-3">OUR PRODUCTS</a>
                        <a href="" className="block mb-2 py-3">ABOUT US</a>
                        <a href="" className="block mb-2 py-3">CONTACT US</a>
